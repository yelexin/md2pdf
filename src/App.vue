...
***
*****
![blockchain](https://avatar-alioss.tower.im/6797cf0a5f3f4af3a2d3349240438335?t=1567590442 "区块链")
[简书](http://jianshu.com)
- 列表内容
+ 列表内容
* 列表内容
...
\`\`\`
  ...
  methods: {
    ...
    handleClick() {
      this.htmlCode = marked(this.code)
      document.getElementById('result').innerHTML = this.htmlCode
    }
  }
};
</script>
